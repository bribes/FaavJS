...
//AVATAR RENDERS
              ...
              player.renders.skin = `https://crafatar.com/skins/${player.id}`,
              ...
              fetch("https://api.hypixel.net/player?key=63f20355-92d7-42d7-a2a5-6457160aa4eb&uuid=" + player.id).then(a => a.json()).then(a => {
                ...
                player.servers.hypixel.skywars.solo.normal = new Object({}),
                  player.servers.hypixel.skywars.solo.normal.wins = a.player.stats.SkyWars.wins_solo_normal,
                  player.servers.hypixel.skywars.solo.normal.losses = a.player.stats.SkyWars.losses_solo_normal,
                  player.servers.hypixel.skywars.solo.normal.games_played = (player.servers.hypixel.skywars.solo.normal.wins + player.servers.hypixel.skywars.solo.normal.losses),
                  player.servers.hypixel.skywars.solo.normal.kills = a.player.stats.SkyWars.kills_solo_normal,
                  player.servers.hypixel.skywars.solo.normal.deaths = a.player.stats.SkyWars.deaths_solo_normal,
                  player.servers.hypixel.skywars.solo.normal.kd = roundNumber(player.servers.hypixel.skywars.solo.normal.kills / player.servers.hypixel.skywars.solo.normal.deaths, 2),
                  player.servers.hypixel.skywars.solo.normal.wl = roundNumber(player.servers.hypixel.skywars.solo.normal.wins / player.servers.hypixel.skywars.solo.normal.losses, 2);

                //HYPIXEL SKYWARS SOLO INSANE
                player.servers.hypixel.skywars.solo.insane = new Object({}),
                  player.servers.hypixel.skywars.solo.insane.wins = a.player.stats.SkyWars.wins_solo_insane,
                  player.servers.hypixel.skywars.solo.insane.losses = a.player.stats.SkyWars.losses_solo_insane,
                  player.servers.hypixel.skywars.solo.insane.games_played = (player.servers.hypixel.skywars.solo.insane.wins + player.servers.hypixel.skywars.solo.insane.losses),
                  player.servers.hypixel.skywars.solo.insane.kills = a.player.stats.SkyWars.kills_solo_insane,
                  player.servers.hypixel.skywars.solo.insane.deaths = a.player.stats.SkyWars.deaths_solo_insane,
                  player.servers.hypixel.skywars.solo.insane.kd = roundNumber(player.servers.hypixel.skywars.solo.insane.kills / player.servers.hypixel.skywars.solo.insane.deaths, 2),
                  player.servers.hypixel.skywars.solo.insane.wl = roundNumber(player.servers.hypixel.skywars.solo.insane.wins / player.servers.hypixel.skywars.solo.insane.losses, 2);
                ...
                player.servers.hypixel.skywars.doubles.normal = new Object({}),
                  player.servers.hypixel.skywars.doubles.normal.wins = a.player.stats.SkyWars.wins_team_normal,
                  player.servers.hypixel.skywars.doubles.normal.losses = a.player.stats.SkyWars.losses_team_normal,
                  player.servers.hypixel.skywars.doubles.normal.games_played = (player.servers.hypixel.skywars.doubles.normal.wins + player.servers.hypixel.skywars.doubles.normal.losses),
                  player.servers.hypixel.skywars.doubles.normal.kills = a.player.stats.SkyWars.kills_team_normal,
                  player.servers.hypixel.skywars.doubles.normal.deaths = a.player.stats.SkyWars.deaths_team_normal,
                  player.servers.hypixel.skywars.doubles.normal.kd = roundNumber(player.servers.hypixel.skywars.doubles.normal.kills / player.servers.hypixel.skywars.doubles.normal.deaths, 2),
                  player.servers.hypixel.skywars.doubles.normal.wl = roundNumber(player.servers.hypixel.skywars.doubles.normal.wins / player.servers.hypixel.skywars.doubles.normal.losses, 2);

                //HYPIXEL SKYWARS DOUBLES INSANE
                player.servers.hypixel.skywars.doubles.insane = new Object({}),
                  player.servers.hypixel.skywars.doubles.insane.wins = a.player.stats.SkyWars.wins_team_insane,
                  player.servers.hypixel.skywars.doubles.insane.losses = a.player.stats.SkyWars.losses_team_insane,
                  player.servers.hypixel.skywars.doubles.insane.games_played = (player.servers.hypixel.skywars.doubles.insane.wins + player.servers.hypixel.skywars.doubles.insane.losses),
                  player.servers.hypixel.skywars.doubles.insane.kills = a.player.stats.SkyWars.kills_team_insane,
                  player.servers.hypixel.skywars.doubles.insane.deaths = a.player.stats.SkyWars.deaths_team_insane,
                  player.servers.hypixel.skywars.doubles.insane.kd = roundNumber(player.servers.hypixel.skywars.doubles.insane.kills / player.servers.hypixel.skywars.doubles.insane.deaths, 2),
                  player.servers.hypixel.skywars.doubles.insane.wl = roundNumber(player.servers.hypixel.skywars.doubles.insane.wins / player.servers.hypixel.skywars.doubles.insane.losses, 2);
                ...
                fetch("https://api.hypixel.net/status?key=63f20355-92d7-42d7-a2a5-6457160aa4eb&uuid=" + player.id).then(a => a.json()).then(a => {
                  ...
                  fetch("https://api.hypixel.net/guild?key=63f20355-92d7-42d7-a2a5-6457160aa4eb&player=" + player.id).then(a => a.json()).then(e => {
                    ...
                    fetch("https://api.hypixel.net/friends?key=63f20355-92d7-42d7-a2a5-6457160aa4eb&uuid=" + player.id).then(a => a.json()).then(e => {
                      ...
                      for (var a = started_length - 1; a >= 0; a--) {
                        started_rev.push(started_arr[a]);
                      }
