...
player.type; //returns the account type of the player. The response can be normal, legacy, or nonexistent. (normal means that the account is either Mojang or Microsoft)
